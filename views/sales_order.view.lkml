view: sales_order {
  sql_table_name: `m2_costway_de.sales_order`
    ;;
  ...
  dimension: trustedshops_mails_accepted {
    type: number
    sql: ${TABLE}.trustedshops_mails_accepted ;;
  }

  dimension: trustedshops_mails_identifier {
    type: string
    sql: ${TABLE}.trustedshops_mails_identifier ;;
  }
